...
\AddToShipoutPicture*{\put(168,550){\includegraphics[scale=1]{../tieude.pdf}}}
\centering
\endgroup
\vspace*{155pt}
...
\begin{multicols}{2}	
	...
	\begin{center}
		\begin{tikzpicture}[domain=-4:4]
			\draw[-stealth] (-4.2,0) -- (4.2,0) node[right] {$x$};
			\draw[-stealth] (0,-1.2) -- (0,4.2) node[above] {$y$};
			
			\draw[color=red]    plot (\x,\x^2);
		\draw (3.43,4.5) ellipse (3cm and 1.25cm);
		\draw (3.43,2) ellipse (2cm and 0.75cm);
	\end{tikzpicture}
	\end{center}
	\begin{figure}[H]
		\vspace*{-5pt}
...
%		\caption{\small\textit{\color{duongvaotoanhoc}Hình $3$. Các đường cong với kỳ dị tại $O(0,0)$.}}
%		\vspace*{-10pt}
%	\end{figure}
%	$\begin{array}{cccc}
%		\includegraphics[width=15ex]{sing03.png} &
%		\includegraphics[width=13ex]{sing04.png} &
%		\includegraphics[width=18ex]{sing05.png}&
%		\includegraphics[width=18ex]{sing06.png}\\
%		F=x^3-y^2 & F=x^3+x^2-y^2& F=(x^2 + y^2)^2 + 3x^2y-y^3 & F=(x^2 + y^2)^3- 4x^2y^2 
%	\end{array}$
